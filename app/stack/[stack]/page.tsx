...
//   },
//   {
//     key: "Blockchain (Theta)",
//     title: "Blockchain (Theta)",
//     description: "Integrate with Theta Blockchain for video streaming applications.",
//     icon: "/images/logo/icon.svg",
//   },
//   {
//     key: "Token Creation",
//     parent: "Blockchain (Theta)",
//     title: "Token Creation",
//     description: "Create and deploy your own ERC-20 token on the Theta Blockchain.",
//     icon: "/images/icons/currency-token.svg",
//   },
//   {
//     key: "Wallet Integration",
//     parent: "Blockchain (Theta)",
//     title: "Wallet Integration",
//     description: "Integrate Theta Wallet for managing ERC-20 tokens and transactions.",
//     icon: "/images/icons/wallet.svg",
//   },
//   {
//     key: "Smart Contract Interaction",
//     parent: "Blockchain (Theta)",
//     title: "Smart Contract Interaction",
//     description: "Interact with smart contracts on the Theta Blockchain.",
...
//   { from: "Frontend (React)", to: "Backend (Node.js)" },
//   { from: "Backend (Node.js)", to: "Blockchain (Solidity)" },
//   { from: "Frontend (React)", to: "Blockchain (Theta)" },
//   { from: "Blockchain (Theta)", to: "Token Creation" },
//   { from: "Blockchain (Theta)", to: "Wallet Integration" },
//   { from: "Blockchain (Theta)", to: "Smart Contract Interaction" },
//   { from: "Token Creation", to: "Deploy Token Contract" },
//   { from: "Deploy Token Contract", to: "Manage Tokens" },
//   { from: "Wallet Integration", to: "User Authentication" },
//   { from: "User Authentication", to: "Transaction Management" },
//   { from: "Smart Contract Interaction", to: "Read Contract Data" },
//   { from: "Smart Contract Interaction", to: "Write Contract Data" },
// ];` as any;
